...
action_table_init = pd.DataFrame('', index=range(10), columns=_action_cols).to_dict('records')
...
app.layout = html.Div(style=PAGE_STYLE, children=[
    ...
    dcc.Store(id='fig-store-bar'),
    dcc.Store(id='fig-store-box'),
    dcc.Store(id='fig-store-bubble'),
    dcc.Store(id='fig-store-heatmap'),
    dcc.Store(id='fig-store-stacked'),
    dcc.Store(id='fig-store-resource'),
    ...
    dcc.Tabs(style={'marginBottom': '0'}, children=[
        ...
        dcc.Tab(label='Workload Analysis', style=TAB_STYLE, selected_style=TAB_SELECTED_STYLE, children=[
            ...
            html.Div(style={'display': 'grid', 'gridTemplateColumns': '1fr 1fr', 'gap': '12px', 'marginBottom': '12px'}, children=[
                ...
                # Bar Chart card
                html.Div(style={'backgroundColor': 'rgba(255,255,255,0.04)', 'border': '1px solid rgba(255,255,255,0.1)', 'borderRadius': '8px', 'padding': '12px', 'position': 'relative'}, children=[
                    html.Button('⛶', id='expand-bar', n_clicks=0, title='Expand',
                                style={'position': 'absolute', 'top': '8px', 'right': '8px', 'backgroundColor': 'rgba(100,150,255,0.15)', 'color': 'rgba(255,255,255,0.6)', 'border': '1px solid rgba(255,255,255,0.2)', 'borderRadius': '4px', 'cursor': 'pointer', 'padding': '1px 7px', 'fontSize': '13px', 'zIndex': 10}),
                    html.Div(style={'display': 'flex', 'alignItems': 'center', 'gap': '12px', 'marginBottom': '6px', 'paddingRight': '36px'}, children=[
                        html.Span(id='fte', style={'color': '#ffcc44', 'fontWeight': 'bold', 'fontSize': '14px', 'whiteSpace': 'nowrap'}),
                        dcc.Dropdown(id='x-axis-column',
                                     ...
                                     value='Activity_type', style={**DROPDOWN_STYLE, 'flex': '1'}),
                    ]),
                    dcc.Graph(id='bar-chart', style={'height': '300px'}, config={'displayModeBar': False}),
                    html.Div(id='bar-chart-summary', style={'fontSize': '11px', 'color': '#8899bb', 'marginTop': '4px'}),
                ]),

                # Box Plot card
                html.Div(style={'backgroundColor': 'rgba(255,255,255,0.04)', 'border': '1px solid rgba(255,255,255,0.1)', 'borderRadius': '8px', 'padding': '12px', 'position': 'relative'}, children=[
                    html.Button('⛶', id='expand-box', n_clicks=0, title='Expand',
                                style={'position': 'absolute', 'top': '8px', 'right': '8px', 'backgroundColor': 'rgba(100,150,255,0.15)', 'color': 'rgba(255,255,255,0.6)', 'border': '1px solid rgba(255,255,255,0.2)', 'borderRadius': '4px', 'cursor': 'pointer', 'padding': '1px 7px', 'fontSize': '13px', 'zIndex': 10}),
                    html.Div(style={'display': 'flex', 'alignItems': 'center', 'gap': '12px', 'marginBottom': '6px', 'paddingRight': '36px'}, children=[
                        html.Span('Task Time Distribution', style={'color': '#aaccff', 'fontWeight': 'bold', 'fontSize': '13px', 'whiteSpace': 'nowrap'}),
                        dcc.Dropdown(id='multi-x-axis-columns',
                                     options=[
                                         {'label': 'Resource', 'value': 'Resource'},
                                         {'label': 'Activity Type', 'value': 'Activity_type'},
                                     ...
                                     value='Resource', style={**DROPDOWN_STYLE, 'flex': '1'}),
                    ]),
                    dcc.Graph(id='box-plot', style={'height': '300px'}, config={'displayModeBar': False}),
                    html.Div(id='box-plot-summary', style={'fontSize': '11px', 'color': '#8899bb', 'marginTop': '4px'}),
                ]),
            ]),

            # ── Row 2: Bubble Chart + Heatmap ──
            html.Div(style={'display': 'grid', 'gridTemplateColumns': '1fr 1fr', 'gap': '12px', 'marginBottom': '12px'}, children=[

                # Bubble Chart card
                html.Div(style={'backgroundColor': 'rgba(255,255,255,0.04)', 'border': '1px solid rgba(255,255,255,0.1)', 'borderRadius': '8px', 'padding': '12px', 'position': 'relative'}, children=[
                    html.Button('⛶', id='expand-bubble', n_clicks=0, title='Expand',
                                style={'position': 'absolute', 'top': '8px', 'right': '8px', 'backgroundColor': 'rgba(100,150,255,0.15)', 'color': 'rgba(255,255,255,0.6)', 'border': '1px solid rgba(255,255,255,0.2)', 'borderRadius': '4px', 'cursor': 'pointer', 'padding': '1px 7px', 'fontSize': '13px', 'zIndex': 10}),
                    html.Span('Bubble Chart — Time by Day & Resource', style={'color': '#aaccff', 'fontWeight': 'bold', 'fontSize': '13px', 'display': 'block', 'marginBottom': '6px', 'paddingRight': '36px'}),
                    dcc.Graph(id='bubble-plot', style={'height': '300px'}, config={'displayModeBar': False}),
                    html.Div(id='bubble-plot-summary', style={'fontSize': '11px', 'color': '#8899bb', 'marginTop': '4px'}),
                ]),

                # Heatmap card
                html.Div(style={'backgroundColor': 'rgba(255,255,255,0.04)', 'border': '1px solid rgba(255,255,255,0.1)', 'borderRadius': '8px', 'padding': '12px', 'position': 'relative'}, children=[
                    html.Button('⛶', id='expand-heatmap', n_clicks=0, title='Expand',
                                style={'position': 'absolute', 'top': '8px', 'right': '8px', 'backgroundColor': 'rgba(100,150,255,0.15)', 'color': 'rgba(255,255,255,0.6)', 'border': '1px solid rgba(255,255,255,0.2)', 'borderRadius': '4px', 'cursor': 'pointer', 'padding': '1px 7px', 'fontSize': '13px', 'zIndex': 10}),
                    html.Div(style={'display': 'flex', 'gap': '8px', 'marginBottom': '6px', 'paddingRight': '36px', 'flexWrap': 'wrap'}, children=[
                        html.Span('Heatmap', style={'color': '#aaccff', 'fontWeight': 'bold', 'fontSize': '13px', 'alignSelf': 'center', 'whiteSpace': 'nowrap'}),
                        dcc.Dropdown(id='x-axis-dropdown',
                                     options=[{'label': 'Timelines', 'value': 'Timelines'}, {'label': 'Activity Type', 'value': 'Activity_type'}, {'label': 'Resource', 'value': 'Resource'}, {'label': 'Entity', 'value': 'Entity'}],
                                     value='Timelines', placeholder='X', style={**DROPDOWN_STYLE, 'flex': '1', 'minWidth': '90px'}),
                        dcc.Dropdown(id='y-axis-dropdown',
                                     options=[{'label': 'Activity Type', 'value': 'Activity_type'}, {'label': 'Timelines', 'value': 'Timelines'}, {'label': 'Resource', 'value': 'Resource'}, {'label': 'Entity', 'value': 'Entity'}],
                                     value='Activity_type', placeholder='Y', style={**DROPDOWN_STYLE, 'flex': '1', 'minWidth': '90px'}),
                    ]),
                    dcc.Graph(id='heatmap', style={'height': '300px'}, config={'displayModeBar': False}),
                    html.Div(id='heatmap-summary', style={'fontSize': '11px', 'color': '#8899bb', 'marginTop': '4px'}),
                ]),
            ]),

            # ── Row 3: Stacked Workload (full width) ──
            html.Div(style={'backgroundColor': 'rgba(255,255,255,0.04)', 'border': '1px solid rgba(255,255,255,0.1)', 'borderRadius': '8px', 'padding': '12px', 'position': 'relative', 'marginBottom': '12px'}, children=[
                html.Button('⛶', id='expand-stacked', n_clicks=0, title='Expand',
                            style={'position': 'absolute', 'top': '8px', 'right': '8px', 'backgroundColor': 'rgba(100,150,255,0.15)', 'color': 'rgba(255,255,255,0.6)', 'border': '1px solid rgba(255,255,255,0.2)', 'borderRadius': '4px', 'cursor': 'pointer', 'padding': '1px 7px', 'fontSize': '13px', 'zIndex': 10}),
                html.Div(style={'display': 'flex', 'gap': '20px', 'alignItems': 'flex-start'}, children=[
                    html.Div(style={'width': '160px', 'flexShrink': 0}, children=[
                        html.Label('Capacity Line 1 (Red):', style={**LABEL_STYLE, 'fontSize': '12px'}),
                        ...
                        html.Label('Capacity Line 2 (Orange):', style={**LABEL_STYLE, 'fontSize': '12px'}),
                        dcc.Input(id='threshold-line2', type='number', value=0, step=0.5,
                                  style={'width': '100%', 'backgroundColor': '#001', 'color': 'white', 'border': '1px solid #555', 'padding': '4px'}),
                    ]),
                    html.Div(style={'flex': 1}, children=[
                        dcc.Graph(id='stacked-bar-chart', style={'height': '320px'}, config={'displayModeBar': False}),
                    ]),
                ]),
                html.Div(style={'marginTop': '12px'}, children=[
                    html.H4('Top 3 Activities by FTE per Work Day', style={'color': '#66aaff', 'fontSize': '14px', 'marginBottom': '6px'}),
                    dash_table.DataTable(
                        id='top-activities-table',
                        columns=[{'name': 'Work Day', 'id': 'Timelines'}, {'name': 'Activity Type', 'id': 'Activity_type'}, {'name': 'FTE', 'id': 'Time_taken_FTE'}],
                        data=[],
                        style_table={'overflowX': 'auto'},
                        style_header={'backgroundColor': '#003366', 'color': 'white', 'fontWeight': 'bold'},
                        style_cell={'textAlign': 'center', 'backgroundColor': 'rgba(0,0,40,0.8)', 'color': 'white', 'fontFamily': 'Calibri', 'padding': '7px'},
                        page_size=12,
                    ),
                ]),
            ]),

            # ── Row 4: Resource Comparison (full width) ──
            html.Div(style={'backgroundColor': 'rgba(255,255,255,0.04)', 'border': '1px solid rgba(255,255,255,0.1)', 'borderRadius': '8px', 'padding': '12px', 'position': 'relative'}, children=[
                html.Button('⛶', id='expand-resource', n_clicks=0, title='Expand',
                            style={'position': 'absolute', 'top': '8px', 'right': '8px', 'backgroundColor': 'rgba(100,150,255,0.15)', 'color': 'rgba(255,255,255,0.6)', 'border': '1px solid rgba(255,255,255,0.2)', 'borderRadius': '4px', 'cursor': 'pointer', 'padding': '1px 7px', 'fontSize': '13px', 'zIndex': 10}),
                html.Div(id='resource-overload-alert', style={'color': '#ff7755', 'fontSize': '13px', 'fontWeight': 'bold', 'marginBottom': '8px'}),
                html.Div(style={'display': 'flex', 'alignItems': 'center', 'gap': '12px', 'marginBottom': '6px', 'paddingRight': '36px'}, children=[
                    html.Span('Resource Comparison — Task Duration by Resource', style={'color': '#aaccff', 'fontWeight': 'bold', 'fontSize': '13px', 'whiteSpace': 'nowrap'}),
                    dcc.Dropdown(id='resource-activity-selector', placeholder='Select activity type…',
                                 style={**DROPDOWN_STYLE, 'width': '260px'}),
                ]),
                dcc.Graph(id='resource-task-box', style={'height': '300px'}, config={'displayModeBar': False}),
            ]),
    ...
    # ---- Exit ----
    # ---- Chart Expand Modal (page-level overlay) ----
    html.Div(id='chart-modal', style={'display': 'none'}, children=[
        html.Div(style={
            'position': 'fixed', 'top': 0, 'left': 0, 'width': '100vw', 'height': '100vh',
            'backgroundColor': 'rgba(0,0,10,0.92)', 'zIndex': 9999,
            'display': 'flex', 'flexDirection': 'column',
            'alignItems': 'center', 'justifyContent': 'center', 'padding': '24px',
        }, children=[
            html.Div(style={'width': '94vw', 'maxWidth': '1400px', 'backgroundColor': 'rgba(0,0,40,0.97)', 'borderRadius': '10px', 'border': '1px solid rgba(255,255,255,0.2)', 'padding': '20px'}, children=[
                html.Div(style={'display': 'flex', 'justifyContent': 'space-between', 'alignItems': 'center', 'marginBottom': '12px'}, children=[
                    html.H3(id='modal-chart-title', style={'color': '#66aaff', 'margin': 0}),
                    html.Button('✕  Close', id='modal-close', n_clicks=0,
                                style={'backgroundColor': 'rgba(200,50,50,0.3)', 'color': 'white', 'border': '1px solid rgba(255,100,100,0.4)', 'borderRadius': '4px', 'cursor': 'pointer', 'padding': '6px 16px', 'fontSize': '14px'}),
                ]),
                dcc.Graph(id='modal-chart', style={'height': '72vh'}, config={'displayModeBar': True}),
            ]),
        ]),
    ]),
...
def update_bar_chart(x_col, file_path):
    ...
    try:
        ...
        return f'Peak Load = {peak_fte:.2f} FTE  |  Peak Day = {peak_day}', fig, summary, fig
    except Exception as e:
...
def update_stacked_bar_chart(file_path, thr1, thr2):
    ...
    try:
        ...
        return fig, top.to_dict('records'), fig
    except Exception as e:
...
@app.callback(
    [Output('resource-task-box', 'figure'),
     Output('fig-store-resource', 'data')],
...
_CHART_TITLES = {
    'expand-bar':      'Total FTE by Group',
    'expand-box':      'Task Time Distribution',
    'expand-bubble':   'Bubble Chart — Time by Day & Resource',
    'expand-heatmap':  'Heatmap',
    'expand-stacked':  'Stacked Workload by Work Day',
    'expand-resource': 'Task Duration by Resource',
}
...
@app.callback(
    ...
    [Input('expand-bar',      'n_clicks'),
     Input('expand-box',      'n_clicks'),
     Input('expand-bubble',   'n_clicks'),
     Input('expand-heatmap',  'n_clicks'),
     Input('expand-stacked',  'n_clicks'),
     Input('expand-resource', 'n_clicks'),
     Input('modal-close',     'n_clicks')],
    [State('fig-store-bar',      'data'),
     State('fig-store-box',      'data'),
     State('fig-store-bubble',   'data'),
     State('fig-store-heatmap',  'data'),
     State('fig-store-stacked',  'data'),
     State('fig-store-resource', 'data')],
    prevent_initial_call=True,
)
def handle_modal(nb, nbo, nbu, nh, ns, nr, nc,
                 fig_bar, fig_box, fig_bubble, fig_heat, fig_stacked, fig_res):
    ...
    fig_map = {
        'expand-bar':      fig_bar,
        'expand-box':      fig_box,
        'expand-bubble':   fig_bubble,
        'expand-heatmap':  fig_heat,
        'expand-stacked':  fig_stacked,
        'expand-resource': fig_res,
    }
    fig = fig_map.get(trigger_id)
    title = _CHART_TITLES.get(trigger_id, '')

    if fig:
        return _MODAL_VISIBLE, fig, title
    return _MODAL_HIDDEN, {}, ''
